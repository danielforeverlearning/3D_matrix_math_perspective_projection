...
public class Point4 {
	...
	public Point4(double xx, double yy, double zz, double ww) {
		 x = xx;
		 y = yy;
		 z = zz;
		 w = ww;
	...
	public Vector CalculateCrossProduct(Point4 P, Point4 Q) {
   ...
   ******************************************/
   ...
   public void Divide_Each_Axis_Value_By(double temp) {
